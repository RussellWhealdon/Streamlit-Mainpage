...
with st.container():
    ...
    st.markdown(f"<h4><a href='{url_WF}' target='_blank'>Reporting Dashboard w/ Custom Visuals using direct BigQuery connection</a></h4>", unsafe_allow_html=True)
...
with st.container():
    ...
    st.markdown(f"<h4 style='text-align: left; color: white;'>Period over Period Comparison for Account Managers</h4>", unsafe_allow_html=True)
